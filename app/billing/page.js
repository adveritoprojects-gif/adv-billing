...
function BillingPageInner() {
  ...
  const insuranceAmt = ((taxable + taxAmt) * insurancePct) / 100;
  ...
  return (
    <div>
      <SectionHeader
        title="New bill"
        subtitle="Build an itemized invoice for a patient visit"
      />
      ...
      <div className="grid lg:grid-cols-5 gap-4">
          ...
          <div className="rounded-lg bg-white p-4 border border-border">
            ...
            {patientXrays.length > 0 && (
              <div className="mt-1 mb-2">
                <div className="text-xs mt-2 mb-1 text-inkSoft">
                  X-rays on file for this patient
                </div>
                ...
                {patientXrays.map((x) => (
                  ...
                  >
                    <input
                      type="checkbox"
                      checked={selectedXrayIds.includes(x.id)}
                      onChange={() => toggleXray(x.id)}
                    />

                    <span className="text-ink">
                      {x.type} <span className="text-inkSoft">({x.date})</span>
                    </span>
              ...
              <div className="mt-2 border-t border-border pt-2">
                {customItems.map((c, idx) => (
                  ...
                  >
                    ...
                    <button onClick={() => removeCustomItem(idx)} type="button">
            ...
            <div className="flex gap-2 mt-3 pt-3 border-t border-border">
              <TextInput
                placeholder="Other charge (e.g. bandage)"
                value={customDesc}
              ...
              <button
                ...
                type="button"
                className="rounded-md px-3 text-sm text-white bg-teal"
              >
                Add
              </button>
            </div>
        ...
        <div className="lg:col-span-2">
          <div className="rounded-lg bg-white p-4 sticky top-4 border border-border">
            ...
            <p className="text-xs mb-3 text-inkSoft">
              {patient
            ...
            <div className="text-sm divide-y divide-border">
              ...
              {lineItems.length === 0 && (
                <p className="py-3 text-xs text-inkSoft">
            ...
            <div className="mt-2 pt-2 border-t border-border text-sm space-y-1">
              ...
              {insuranceAmt > 0 && (
                <div className="flex justify-between text-inkSoft">
                  ...
                  <span className="tabular-nums">−{fmt(insuranceAmt)}</span>
                </div>
              )}
